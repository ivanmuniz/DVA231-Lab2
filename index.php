...
-->
					<?php
						for($i=0; $i<count($arrayCol4Data); $i++) {
							...
							$display = ($arrayCol4Data[$i]['display'] == 0)?('class="display-none"'):('');
							echo "<tr id=\"$id\" $display>";
								echo "<td colspan=\"4\" class=\"box-4col\" style=\"background-image: url('$img');\">";
						...
						<td id="box004" colspan="2" class="table-news-td-right box-2col">
							...
							<div class="pat-textbox">
								<div class="pat-textbox-text">
									...
									<br/><br/>
									<span class="pat-textbox-bottom">
										<?php for($i=0; $i<count($arrayPtbData['bottom']);$i++) {
